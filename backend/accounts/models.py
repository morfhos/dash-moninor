...
class Cliente(models.Model):
    ...
    report_emails = models.TextField(blank=True, default="", help_text="E-mails para relatórios (um por linha)")
    whatsapp = models.CharField(max_length=20, blank=True, default="", help_text="Ex: 5511999999999")
    whatsapp_reports = models.BooleanField(default=False, help_text="Enviar relatórios periódicos via WhatsApp")
